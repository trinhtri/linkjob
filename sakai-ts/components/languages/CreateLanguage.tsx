...
interface Props {
    ...
    onCancel: () => void;
    onSubmit: () => void;
    register: UseFormRegister<CreateOrUpdateLanguageRequest>;
    getValues: UseFormGetValues<CreateOrUpdateLanguageRequest>;
    errors: FieldErrors<CreateOrUpdateLanguageRequest>;
}

const CreateLanguage = ({ visible, errors, isLoading, onCancel, onSubmit, register, getValues }: Props) => {
